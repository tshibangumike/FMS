...
namespace fms.Service
{
    public class InformantService
    {
        ...
        {
            var records = SharedService.ExecuteGetSqlStoredProcedure("[bbu].[Informant_querybyid]",
        ...
        {
            var records = SharedService.ExecuteGetSqlStoredProcedure("[bbu].[Informant_querycountofinformantsbyfuneralid]",
                 new List<SqlParameter>
                    {
                            new SqlParameter("@funeralId", funeralId),
                    });
