            ...
            function($scope, appService, informants) {
                ...
                $scope.edit = function(record) {
                    if (_.isNull(record) || _.isUndefined(record)) {
                        ...
                        appService.NavigateTo("editinformant", { informantid: selectedRecords[0]["Id"] });
                    } else
    ...
    .controller("EditInformantController",
        [
            ...
            function($scope, $uibModal, appService, record) {
                ...
                $scope.DeactivateInformant = function () {
                    appService.GetData(fms.Entity.Informant.Urls.DeactivateInformant,
                            {
                                informantId: $scope.record["Id"]
                            })
                        .then(function (response) {
                                appService.NavigateTo("informant-list");
                            },
                            function (response) {
                            });
                };
                ...
                $scope.Delete = function () {
                    fms.Routes.ConfirmationLookup($uibModal, $scope.DeactivateInformant);
                };
